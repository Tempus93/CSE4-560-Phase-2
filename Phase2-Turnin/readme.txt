...
we move it to the final/main tables. after we are done with the temporary table, we delete it from the schema. 
...
Simple way to do this is just replace all "C:/Users/Public/Documents/" texts in the file the location you stored the 
data csvs. VS Code has this Replace all Function, which was used when making location modifications.